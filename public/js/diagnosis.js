                      ...
                      .done(function(datas) {
                        ...
                        datas.data.forEach(function(point_data) {
                          ...
                          if (i == 0) {
                            ...
                            point[i] =
                              point[i - 1] + Number(point_data.element_point);
                          }
                          i = i + 1;
                        });
                        if (datas.message == "取得成功") {
                          ...
                          if (day_point_count >= 7) {
                            var day_point_last = day_point.slice(
                              day_point_count - 7,
                              day_point_count
                            );
                            var sum_point_last = point.slice(
                              day_point_count - 7,
                              day_point_count
                            );
                            var day_create_last = create_day.slice(
                              day_point_count - 7,
                              day_point_count
                            );
                          } else {
                          ...
                          var ctx = document
                            ...
                            .getContext("2d");
                          var ctx_bar = document
                            .getElementById("canvas_bar")
                            .getContext("2d");
